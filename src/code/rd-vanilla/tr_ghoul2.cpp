...
static qboolean G2_EnsureSkinWorker( void )
{
	...
	s_g2WorkerThid = sceKernelCreateThread( "g2skin", G2_SkinWorker, 0x100000FF, 0x10000, 0, SCE_KERNEL_CPU_MASK_USER_0, NULL );	// above the mixer: anim jobs gate the frame
