...
# SDL2 is built in-tree from the submodule by CMakeLists.txt, so there is nothing
# to install over the SDK here -- configure and build is the whole job.
echo "==> Building JAVITA"
